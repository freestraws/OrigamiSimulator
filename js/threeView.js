...
module.exports.scene = new THREE.Scene();
module.exports.modelWrapper = new THREE.Object3D();

module.exports.camera = new THREE.PerspectiveCamera(60, window.innerWidth/window.innerHeight, 0.1, 500);
...
module.exports.renderer = new THREE.WebGLRenderer({antialias: true});
...
module.exports.resetCamera = function(){
    camera.zoom = 7;
...
module.exports.setCameraX = function(sign){
    controls.reset(new THREE.Vector3(sign,0,0));
}
module.exports.setCameraY = function(sign){
    controls.reset(new THREE.Vector3(0,sign,0));
}
module.exports.setCameraZ = function(sign){
    controls.reset(new THREE.Vector3(0,0,sign));
}
module.exports.setCameraIso = function(){
    controls.reset(new THREE.Vector3(1,1,1));
}

module.exports.startAnimation = function(){
    console.log("starting animation");
    renderer.animate(_loop);
}

module.exports.pauseSimulation = function(){
    globals.simulationRunning = false;
    console.log("pausing simulation");
}

module.exports.startSimulation = function(){
...
module.exports.sceneAddModel = function(object){
    modelWrapper.add(object);
}

module.exports.onWindowResize = function() {
...
module.exports.enableControls = function(state){
...
module.exports.resetModel = function(){
